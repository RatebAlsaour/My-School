...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Register Master') }}</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('create-Master') }}">
                            ...
                            <div class="row mb-3">
                                <label for="work_time"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Work time') }}</label>

                                <div class="col-md-6">
                                    <input id="work_time" type="work_time"
                                        class="form-control @error('work_time') is-invalid @enderror" name="work_time"
                                        required autocomplete="new-work_time">
                ...
                @if ($user = Session::get('user'))
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-center">{{ __('Master') }}</div>
                        </div>
                        <div class="card-body">
