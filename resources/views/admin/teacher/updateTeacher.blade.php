...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Update Teacher') }}</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('update-teacher') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="f_name" type="text"
                                        ...
                                        value="{{ $data[0]->employee->f_name }}" required autocomplete="name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="m_name" type="text"
                                        ...
                                        value="{{ $data[0]->employee->m_name }}" required autocomplete="name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="l_name" type="text"
                                        ...
                                        value="{{ $data[0]->employee->l_name }}" required autocomplete="name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="text"
                                        ...
                                        value="{{ $data[0]->employee->email }}"autocomplete="email" autofocus>
                            ...
                            <div class="row mb-3">
                                <label for="edu_degree"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Education Degree') }}</label>

                                <div class="col-md-6">
                                    <input id="edu_degree" type="text"
                                        class="form-control @error('edu_degree') is-invalid @enderror" name="edu_degree"
                                        value="{{ $data[0]->employee->edu_degree }}" required autocomplete="edu_degree"
                                        autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="birthday" type="date"
                                        ...
                                        value="{{ $data[0]->employee->birthday }}" required autocomplete="birthday"
                                        autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="numder"
                                        ...
                                        value="{{ $data[0]->employee->phone }}" required autocomplete="phone" autofocus>
                            ...
                            <div class="row mb-3">
                                <label for="session_price"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Session Praice') }}</label>

                                <div class="col-md-6">
                                    <input id="session_price" type="numder"
                                        class="form-control @error('session_price') is-invalid @enderror"
                                        name="session_price" value="{{ $data[0]->session_price }}" required
                                        autocomplete="session_price" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="salary" type="numder"
                                        class="form-control @error('salary') is-invalid @enderror" name="salary"
                                        value="{{ $data[0]->salary }}" required autocomplete="salary" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="start_date" type="numder"
                                        class="form-control @error('start_date') is-invalid @enderror" name="start_date"
                                        value="{{ $data[0]->employee->start_date }}" required autocomplete="start_date"
                                        autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="city" type="text"
                                        ...
                                        value="{{ $data[0]->employee->address->city }}" required autocomplete="city"
                                        autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="region" type="text"
                                        ...
                                        value="{{ $data[0]->employee->address->region }}" required
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="street" type="text"
                                        ...
                                        value="{{ $data[0]->employee->address->street }}" required
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="bulid_num" type="text"
                                        ...
                                        value="{{ $data[0]->employee->address->bulid_num }}" required
                                        autocomplete="bulid_num" autofocus>
